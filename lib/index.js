...
PostgresStorage = (function () {
    ...
    PostgresStorage.prototype.connect = function (callback) {
        ...
        if (this.db) {
            ...
            if(self.settings.ssl!=null) self.db.ssl = self.settings.ssl;
            if(self.settings.types) self.db.types = self.settings.types;
            if(self.settings.statement_timeout) self.db.statement_timeout = self.settings.statement_timeout;
